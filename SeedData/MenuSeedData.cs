...
public static class MenuSeedData
{
    ...
    public static void Initialize(FreeSqlCloud fsql, long adminUserId, string adminUsername)
    {
        ...
        var rootMenus = new[]
        {
            ...
            CreateComponentDemoMenu(adminUserId, adminUsername),
            CreateUptimeMenu(adminUserId, adminUsername),
    ...
    /// 组件菜单
    /// </summary>
    private static SysMenu CreateComponentDemoMenu(long adminUserId, string adminUsername)
    {
        return CreateRootMenu(
            label: "组件",
            ...
            children:
            [
                CreatePageMenu("字典和参数配置", "Blog/DictParamDemo", 458, "fas fa-sliders-h", adminUserId, adminUsername),
                CreatePageMenu("AdminTable2", "Blog/AdminTable2Demo", 459, "fas fa-table", adminUserId, adminUsername),
                CreatePageMenu("Table2组件", "Blog/Table2Demo", 460, "fas fa-table-columns", adminUserId, adminUsername),
                CreatePageMenu("AdminModal", "Blog/AdminModalDemo", 461, "fas fa-window-restore", adminUserId, adminUsername),
                CreatePageMenu("提示类", "Blog/PromptDemo", 462, "fas fa-bell", adminUserId, adminUsername),
                CreatePageMenu("文件缓存", "Blog/FileCacheDemo", 463, "fas fa-file-archive", adminUserId, adminUsername),
                CreatePageMenu(
                    "AdminButton",
                    "Blog/AdminButtonDemo",
                    464,
                    "fas fa-shield-alt",
                    adminUserId,
                    adminUsername,
    ...
    /// 运维监控菜单
    /// </summary>
    private static SysMenu CreateUptimeMenu(long adminUserId, string adminUsername)
    {
        return CreateRootMenu(
            label: "运维监控",
            ...
            children:
            [
                CreatePageMenu("监控站点", "Uptime/MonitorSite", 471, "fas fa-globe", adminUserId, adminUsername)
            ]);
    }
